...
- PHP 8.4 or higher
- MySQL 5.6 or higher
- Anthropic API account (for testing AI features)
...
4. Configure settings:
   - Add your Anthropic API key (use a test key with rate limits)
   - Enable AI search
...
- AI provider API errors (simulate with invalid Anthropic key)
- Network timeouts
- Database errors
